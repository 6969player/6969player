...
c00lkidd2skybox_2.Text = "coolkid  sky"
...
CK2Logospam.Text = " free mushroom logo spam"
CK2Logospam.TextColor3 = Color3.fromRGB(255, 255, 255)
CK2Logospam.TextSize = 17.000

c00lkiddmessage.Name = "khian69 message"
...
c00lkiddmessage.Text = "khian69 message"
...
k00pkiddParticels.Name = "khian69 Particels"
...
k00pkiddParticels.Text = "nope Particels"
...
local function DSCTENR_fake_script() -- k00pkidddecalspam.LocalScript 
	...
	script.Parent.MouseButton1Down:Connect(function()
		...
		msg.Text = "Khian69 Is Destroying a F@CKING B%TCH GAME!!!!!!!!!!!!!!"
		wait(5.8)
		msg:Destroy()
		s = Instance.new("Sky")
		s.Name = "SKY"
...
local function RKRS_fake_script() -- c00lkiddmessage.LocalScript 
	...
	script.Parent.MouseButton1Down:Connect(function()
		message1 = ("khian69:This game is fucking destroyed by me!!")
		message2 = ("khian69:No one can Ban me!!!")
		message3 = ("c00lkidd:lol, yall allah")
...
local function OFUSQA_fake_script() -- Hint.LocalScript 
	...
	script.Parent.MouseButton1Down:Connect(function()
		message1 = ("No one can Destroy me!!!")
		...
		local function LQLU_fake_script() -- Jumpscare.LocalScript 
			...
			script.Parent.MouseButton1Down:Connect(function()
				function e(p,y) 
					...
					sound.SoundId = "rbxassetid://515669032"
					sound.Volume = 0
					sound.Looped = true
					local aaaa = Instance.new("DistortionSoundEffect",sound)
					aaaa.Level = 0
					local image = Instance.new("ImageLabel",gui)
					image.Image = "https://www.roblox.com/users/8072640341/profile"
		...
		local function OUGQT_fake_script() -- Jumpscare2.LocalScript 
			...
			script.Parent.MouseButton1Down:Connect(function()
				function e(p,y) 
					...
					aaaa.Level = 0
					local image = Instance.new("ImageLabel",gui)
					image.Image = "https://www.roblox.com/asset/121240073429853"
					image.Size = UDim2.new(0,0,0,0)
					image.Position = UDim2.new(0.5,0,0.5,0)
					image.BackgroundTransparency = 1
					image.ImageColor3 = Color3.new(0,0,0)
		...
		local function UCVCDUV_fake_script() -- Jumpscare3.LocalScript 
			...
			script.Parent.MouseButton1Down:Connect(function()
				function e(p,y) 
					...
					aaaa.Level = 0
					local image = Instance.new("ImageLabel",gui)
					image.Image = "rbxassetid://121240073429853"
					image.Size = UDim2.new(0,0,0,0)
					image.Position = UDim2.new(0.5,0,0.5,0)
					image.BackgroundTransparency = 1
					image.ImageColor3 = Color3.new(0,0,0)
